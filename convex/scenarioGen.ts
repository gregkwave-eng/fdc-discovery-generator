...
function buildSystemPrompt(): string {
  return [
    ...
    "  provided context. Use their actual tool names and terminology. No generic filler.",
    "- Each vignette is 2-4 sentences: set a concrete situation, then end with one open question",
    "  that invites the owner to reveal HOW they personally handle it. Never multiple-choice.",
...
function buildUserPrompt(
  ...
  return [
    ...
    transcriptExcerpt ? transcriptExcerpt.slice(0, 6000) : "(no transcript provided)",
    "",
